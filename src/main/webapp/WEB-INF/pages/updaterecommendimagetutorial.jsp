...
<div class="container">
    <h1>查看与修改推荐舞蹈教程封面图片</h1>
    <div class="row">
        <div class="col-md-12">
            <form role="form" action="/darfoobackend/rest/admin/recommend/tutorial/updateimage" method="post" id="createvideoform" name="createvideoform" enctype="multipart/form-data">
                <!--<div style="display: none">
                    <input type="text" name="id" value="${video.id}">
                </div>-->

                <div class="form-group">
                    <label for="title">舞蹈教程标题</label>
                ...
                <button type="submit" class="btn btn-default">更新推荐舞蹈教程封面图片</button>
            </form>
        </div>
    </div>
</div>
