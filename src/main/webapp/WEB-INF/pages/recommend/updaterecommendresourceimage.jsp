...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <form role="form" action="/darfoobackend/rest/admin/recommend/resource/updateimage" method="post"
                  enctype="multipart/form-data">
                <div class="form-group">
                    <label for="title">舞蹈视频标题</label>
                    <input type="text" id="title" class="form-control" value="${resource.title}" disabled="disabled">
                </div>
