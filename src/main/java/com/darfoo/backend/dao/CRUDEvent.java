    ...
    public static String getResponse(int CRUDEvent) {
        ...
        switch (CRUDEvent) {
            ...
            case UPDATE_FAIL:
                res = "UPDATE_FAIL";
                break;
            case UPDATE_VIDEO_NOTFOUND:
                res = "UPDATE_VIDEO_NOTFOUND";
                break;
            case UPDATE_MUSIC_NOTFOUND:
                res = "UPDATE_MUSIC_NOTFOUND";
                break;
            case UPDATE_AUTHOR_NOTFOUND:
                res = "UPDATE_AUTHOR_NOTFOUND";
                break;
            case UPDATE_IMAGE_NOTFOUND:
                res = "UPDATE_IMAGE_NOTFOUND";
                break;
            case DELETE_SUCCESS:
                res = "DELETE_SUCCESS";
                break;
